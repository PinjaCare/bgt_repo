...
@games_controller.route("/edit_player/<int:id>", methods=["GET","POST"])
def edit_game(id):
    connection = get_db_connection()
    ...
    return render_template("edit_game.html", player = game_object) # Selected player exists and will be forwarded to view